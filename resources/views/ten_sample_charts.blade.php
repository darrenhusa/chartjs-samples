...
<head>
  ...
  <title>10 Sample Chart.js Charts</title>
</head>
<body>
  <h1>Chart 1 - Bar Chart</h1>
  <canvas id="bar-chart" width="600" height="250"></canvas>

  <h1>Chart 2 - Doughnut Chart</h1>
  <canvas id="doughnut-chart" width="600" height="250"></canvas>

  <h1>Chart 3 - Horizontal Bar Chart</h1>
  <canvas id="bar-chart-horizontal" width="600" height="350"></canvas>

  <h1>Chart 4 - Line Chart</h1>
  <canvas id="line-chart" width="800" height="450"></canvas>

  <h1>Chart 5 - Mixed Chart</h1>
  <canvas id="mixed-chart" width="800" height="450"></canvas>

  <h1>Chart 6 - Grouped Bar Chart</h1>
  <canvas id="bar-chart-grouped" width="800" height="450"></canvas>

  <h1>Chart 7 - Pie Chart</h1>
